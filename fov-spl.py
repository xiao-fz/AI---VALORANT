...
def main():
    ...
    print(
        f"RapidShot GPU 视频流已启动: {CAPTURE_SIZE}x{CAPTURE_SIZE} "
    ...
    try:
        ...
        while True:
            ...
            frame = cam.get_latest_frame(as_numpy=False)
            tx = ty = None
